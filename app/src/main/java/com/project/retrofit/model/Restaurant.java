...
public class Restaurant {
    ...
    public Restaurant(int id, String adresse, String heure_close, String heure_open, double latitude, double longitude, String nom, String rank, int serie_id, int zone_id, Zone zone, String heureOpen, String heureClose) {
        this.id = id;
